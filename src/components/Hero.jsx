      ...
      <div className="lg:w-1/2 xl:w-full">
        <div className="w-full flex justify-center">
          <img
            src={profile}
            alt="Profile"
            className="w-3/4 lg:w-full xl:w-3/5"
          />
        </div>

        <div className="shadow-custom-1 shadow-zinc-400 dark:shadow-none p-7 rounded-2xl hidden xl:block">
          <p className="text-zinc-900 mb-3 text-lg dark:text-white">
            Hello! I build responsive, elegant and digital experiences for the
            web.
          </p>
          <p className="text-zinc-900 mb-3 text-lg dark:text-white">
            I am a skilled Web Developer with a passion for creating visually
            appealing and user-friendly websites. I am proficient in front-end
            development and have experience building responsive and interactive
            web applications.
          </p>
          <p className="text-zinc-900 mb-3 text-lg dark:text-white">
            Currently focus these days in a leading projects. I am constantly
            expanding my skill set and keeping up with the latest industry
            trends to ensure that I am always at the forefront of web
